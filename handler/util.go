...
// PasswordStrengthInfo 计算密码强度等级（0-4），供前端脚本/提示使用
func PasswordStrengthInfo(pw string) int {
	if len(pw) == 0 {
		return 0
	}
	score := 0
...
// copyRange 从 r 拷贝 n 字节到 w
func copyRange(w io.Writer, r io.Reader, n int64) (int64, error) {
